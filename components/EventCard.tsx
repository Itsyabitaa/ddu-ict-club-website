...
export function EventCard({ event }: EventCardProps) {
    ...
    return (
        <article className={`
            ...
            ${isCompleted ? 'opacity-70 grayscale hover:opacity-100 hover:grayscale-0' : 'hover:-translate-y-2 hover:border-primary hover:shadow-[10px_10px_0px_0px_hsl(var(--primary))]'}
        `}>
            {/* ── Status & Badge area ────────────────────────────────── */}
            ...
            <div className="flex flex-col flex-1 p-6 gap-4">
                ...
                <div className={`h-[2px] w-8 bg-primary transition-all duration-500 ease-out ${!isCompleted && 'group-hover:w-full'}`} />
